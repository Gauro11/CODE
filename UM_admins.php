...
$query = "SELECT * FROM admins WHERE first_name LIKE ? OR last_name LIKE ? OR email LIKE ?";
...
<head>
<meta charset="UTF-8">
<title>User Management - Admins</title>
        ...
        <ul class="sidebar__menu">
            ...
            <li class="menu__item has-dropdown">
                ...
                <ul class="dropdown__menu">
                    ...
                    <li class="menu__item"><a href="UM_admins.php?content=manage-admins" class="menu__link active">Admins</a></li>
